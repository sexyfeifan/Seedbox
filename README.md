...
- 当前版本：`v0.1.74`
- Docker 镜像：
  - `sexyfeifan/seedbox-backend:v0.1.74`
  - `sexyfeifan/seedbox-parser-worker:v0.1.74`
- 最新发布目录：
  - `releases/v0.1.74/docker-compose.yml`
  - `releases/v0.1.74/.env.template`
...
- compose 文件：`releases/v0.1.74/docker-compose.yml`
- 环境变量模板：`releases/v0.1.74/.env.template`
