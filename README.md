...
- 当前版本：`v0.1.69`
- Docker 镜像：
  - `sexyfeifan/seedbox-backend:v0.1.69`
  - `sexyfeifan/seedbox-parser-worker:v0.1.69`
- 最新发布目录：
  - `releases/v0.1.69/docker-compose.yml`
  - `releases/v0.1.69/.env.template`
...
- compose 文件：`releases/v0.1.69/docker-compose.yml`
- 环境变量模板：`releases/v0.1.69/.env.template`
